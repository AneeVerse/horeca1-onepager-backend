                                      ...
                                      <tr>
                                        <td style='width:150px;'>
                                          ...
                                          <img
                                            alt
                                            height='auto'
                                            src='https://res.cloudinary.com/ahossain/image/upload/v1676296566/Horeca1%20files/cc_v8jite.png'
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          <p style='margin:0px; font-size:14; text-transform: uppercase'>${option.company_name || ""
    }</p>
                    
                          <p style='margin:0px;'>${option.company_address || ""
    }</p>
                          <p style='margin:0px;'>
                     
                          ${option.company_phone || ""}</p>
                          <p style='margin:0px;'> ${option.company_email || ""
    }</p>
                          <p style='margin:0px;'> ${option.company_website || ""
    }</p>
                        </td>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        >
                          ...
                          ${option.address || ""} <br />
                          ${option.city || ""} ${option.country || ""} ${option.zipCode || ""}
                        </td>
                  ...
                  <table class='common_table' style='width: 100%;'>
                    <thead>
                      <tr>
                        ...
                        <th style='padding: 2px 4px;text-transform: uppercase; font-size:13px;'>Taxable Value</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style='padding: 2px 4px;text-align:justify; font-size:13px;'>
                          ${option.currency}${(option.taxableSubtotal || 0).toFixed(2)}
                        </td>
                        <td style='padding: 2px 4px;text-align:justify; font-size:13px;'>
                          ${option.currency}${(option.totalGst || 0).toFixed(2)}
                        </td>
                        <td style='padding: 2px 4px;text-align:justify; font-size:13px;'>
